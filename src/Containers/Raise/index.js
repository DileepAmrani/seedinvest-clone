      ...
      <div className={classes.headerContainer}>
        <Container>
          <div className={classes.heroSection}>
            <h1 className={classes.heading}>How to Raise on Placeholder</h1>
            <h1 className={classes.subHeading}>
            Learn about startup finance and how to raise capital on Placeholder.
            </h1>
          </div>
        </Container>
      </div>
        ...
        <Container>
          <div className={classes.step}>
            <Grid container>
              <Grid item xs={12} lg={6}>
                <img
                  src="https://d2v4u62fw1nf2w.cloudfront.net/webapp-static/img/images/how-it-works/raise-founder-final.svg"
                  alt=""
                />
              </Grid>
              <Grid item xs={12} lg={6}>
          ...
          <div className={classes.step}>
            <Grid container>
              <Grid item xs={12} lg={6}>
                <img
                  src="https://d2v4u62fw1nf2w.cloudfront.net/webapp-static/img/images/how-it-works/raise-application-final.svg"
                  alt=""
                />
              </Grid>
              <Grid item xs={12} lg={6}>
                ...
                <p className={classes.stepDescription}>
                  We will personalize your Placeholder experience during the sign
                  up process. By providing us with information about yourself
                  and your investment interests, we will be able to suggest
                  potential companies based on your preferences.
                </p>
                <p className={classes.stepDescription}>
          ...
          <div className={classes.step}>
            <Grid container>
              <Grid item xs={12} lg={6}>
                <img
                  src="https://d2v4u62fw1nf2w.cloudfront.net/webapp-static/img/images/how-it-works/raise-screening-final.svg"
                  alt=""
                />
              </Grid>
              <Grid item xs={12} lg={6}>
          ...
          <div className={classes.step}>
            <Grid container>
              <Grid item xs={12} lg={6}>
                <img
                  src="https://d2v4u62fw1nf2w.cloudfront.net/webapp-static/img/images/how-it-works/raise-dd-final.svg"
                  alt=""
                />
              </Grid>
              <Grid item xs={12} lg={6}>
          ...
          <div className={classes.step}>
            <Grid container>
              <Grid item xs={12} lg={6}>
                <img
                  src="https://d2v4u62fw1nf2w.cloudfront.net/webapp-static/img/images/how-it-works/raise-profile-final.svg"
                  alt=""
                />
              </Grid>
              <Grid item xs={12} lg={6}>
          ...
          <div className={classes.step}>
            <Grid container>
              <Grid item xs={12} lg={6}>
                <img
                  src="https://d2v4u62fw1nf2w.cloudfront.net/webapp-static/img/images/how-it-works/raise-shares-final.svg"
                  alt=""
                />
              </Grid>
              <Grid item xs={12} lg={6}>
