        ...
        <Container>
          <Grid container>
            ...
            <Grid item xs={12} lg={9}>
              <div>
                <h3 className={classes.heading}>Legal Documents</h3>
                <p className={classes.text}>
                  This Privacy Policy explains how Placeholder Technology, LLC
                ...
                <p className={classes.text}>
                  Our lawful basis for processing personal data from you is that
                  it is necessary for our legitimate interests. These legitimate
                  interests are running and growing our business, performing and
                  developing our product/services for you, complying with
                  applicable laws and regulations, preventing fraud, marketing,
                  and IT security.
                </p>
                <p className={classes.text}>
...
export default LegallDocuments;
